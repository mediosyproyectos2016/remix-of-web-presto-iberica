...
const finishesByCategory: Record<string, Finish[]> = {
  ...
  print: [
    ...
    { id: "espiral", name: "Espiral Tribal", code: "#C8A800", description: "Diseño tribal con espirales en negro y dorado. Carácter único y artesanal.", image: acabadoCarbono, maintenance: "Paño de microfibra seco.", productImage: printEspiral },
