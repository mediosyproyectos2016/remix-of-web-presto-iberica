...
const LocalizadorPage = () => {
  ...
  const resultados = useMemo(() => {
    return buscarDistribuidores(searchQuery);
  }, [searchQuery]);
        ...
        <section className="container-presto mb-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Encuentra tu tienda más cercana. Más de {distribuidores.length} puntos 
              de venta autorizados en toda España y Europa.
            </p>
          </motion.div>
        </section>
        ...
        <section className="container-presto mt-16">
          <div className="bg-secondary rounded-3xl p-8 md:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-display mb-4">
              ¿Quieres ser distribuidor Presto?
            </h2>
