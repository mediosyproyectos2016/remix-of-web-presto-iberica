...
export const SocialBar = () => {
  return (
    <section className="bg-foreground py-12 mt-16">
      <div className="container-presto text-center">
        <h3 className="text-background uppercase tracking-widest text-sm font-medium mb-8">
          Síguenos
        </h3>
        <div className="flex items-center justify-center gap-6 flex-wrap">
          {socials.map((social) => (
            <a
              ...
              className="w-12 h-12 flex items-center justify-center border border-background/20 text-background/70 hover:text-background hover:border-background transition-colors"
            >
              {(social as any).isCustom ? (
